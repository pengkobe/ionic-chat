angular.module('devtest.service', [])
    ...
    .factory('Mocking_Groups', function (HttpPromiseService, CREATE_GROUP_URL) { // 成功（废弃，与实际用途不符）
        return {
            init: function () {
                var params = {
                    userid: '5812ebdf4c0b0e79324f6cc4',
                    groupname: 'group1',
                    groupimg: '',
    ...
    // ============群组请求相关
    .factory('mocking_add_GroupRequest', function (HttpPromiseService, REQ_GROUP_MEMBER_URL) { // 成功
        return {
            init: function () {
                var params = {
                    username: 'dl',
                    friendid: '5812ebdf4c0b0e79324f6cbc', // lib
                    groupid: '581b38a6cf381184f5f613d5',
                };
    ...
    .factory('mocking_load_GroupRequest', function (HttpPromiseService, LOAD_GROUP_REQUEST_URL) { // 成功
        return {
            init: function () {
                var params = {
                    username: 'zhouw'
    ...
    .factory('mocking_res_GroupRequest_agree', function (HttpPromiseService, RES_GROUP_REQUEST) { // 成功
        return {
            init: function () {
                var params = {
                    userid: '581db8dfef1a5d19862cdc12',
                    friendid: '5812ebdf4c0b0e79324f6cc4', //dl
                    groupid: '581b38a6cf381184f5f613d5',
                    state: 1
                };
    ...
    .factory('mocking_res_GroupRequest_reject', function (HttpPromiseService, RES_GROUP_REQUEST) { // 成功
        return {
            init: function () {
                var params = {
                    userid: '581db8dfef1a5d19862cdc12',
